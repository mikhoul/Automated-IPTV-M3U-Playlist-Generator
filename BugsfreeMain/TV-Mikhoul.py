...
class ValidationColorFormatter(logging.Formatter):
    ...
    # FIXED: Single red shade, lighter URLs, ACTIVE uppercase
    KEYWORD_COLORS = {
        # Positive status - GREEN ONLY (CHANGED TO UPPERCASE)
...
class M3UCollector:
    ...
    def validate_hls_stream(self, url, headers, timeout, channel_name="Unknown Channel"):
        """
        Validate HLS/M3U8 streams with FIXED logging and URL separation.
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if '#EXTM3U' in content or '#EXT-X-VERSION' in content:
                    ...
                    print(url)  # Print URL on separate line for linkification
    ...
    def validate_regular_url(self, url, headers, timeout, channel_name="Unknown Channel"):
        """
        Validate regular URLs with FIXED logging and URL separation.
            ...
            try:
                ...
                if alt_url != url:  # Only try if URL actually changed
                    ...
                    if response.status_code < 400:
                        ...
                        print(alt_url)  # Print URL on separate line for linkification
                        print()        # Blank line for readability
                        ...
                        for group, channel in url_to_channels[url]:
                            ...
                            if status == 'geo_blocked':
                                if not channel['name'].endswith('[Geo-blocked]'):
                                    ...
                                    print(channel['url'])  # Print URL on separate line for linkification
                                    print()               # Blank line for readability
                                    geo_blocked_count += 1
